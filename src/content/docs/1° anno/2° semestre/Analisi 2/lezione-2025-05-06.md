...
- $D_2 = \Set{a_2 = y_0 < \ldots < y_i < \ldots < x_{n_2} = b_2 }$
- $D_3 = \Set{a_3 = z_0 < \ldots < z_i < \ldots < x_{n_3} = b_3 }$
...
$$
\iiint_A f(x, y, z)\ dx\ dy\ dz = \iiint_{A'} f(\psi(u, v, w))\ |det(A_\psi(u, v, w))|\ du\ dv\ dw
$$
