---
description:
  Topologia di R^n, distanza euclidea, intorni, insiemi aperti e chiusi, e
  limiti di funzioni in più variabili.
lang: it
title: Distanza euclidea, insiemi e limiti in R^n
---
...
Siano $f, g, h: A \subseteq \R^n \to \R$ e sup\mathbf{p}oniamo che
$\forall\ \mathbf{p} \in A \setminus \{\mathbf{\mathbf{p}}_0\},\ f(\mathbf{p}) \leq g(\mathbf{p}) \leq h(\mathbf{p})$
e che
...
- Esiste un limite $L$ per $f$ lungo ogni sottoinsieme $B \subseteq A$ per cui
  ...
  che $\lim_{\mathbf{p} \to \mathbf{p}_0} f_{\vert B}(\mathbf{p}) = L$.
