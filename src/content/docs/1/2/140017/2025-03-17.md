---
description:
  Teorema del differenziale totale e derivate direzionali. Condizioni per la
  differenziabilità di una funzione e la relazione con il gradiente.
lang: it
...
Data una funzione $f$ a più variabili per cui esiste $\nabla f(\mathbf{p}_0)$,
