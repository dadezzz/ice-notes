---
description:
  Definizioni di continuità, derivate parziali, vettore gradiente e condizioni
  di differenziabilità per funzioni di più variabili.
lang: it
title: Funzioni continue, derivate parziali e differenziabilità
---
...
$$
\lim_{x \to x_0} \frac{f(x, y_0) - f(x_0, y_0)}{x - x_0} = \pdv{f}{x}(x_0, y_0)
$$
...
$$
\nabla f(\mathbf{p}_0) = \left(\pdv{f}{x}(x_0, y_0), \pdv{f}{y}(x_0, y_0)\right)
$$
