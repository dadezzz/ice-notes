---
description:
  Teorema del valor medio in n variabili, matrice Jacobiana e regola della
  catena per funzioni composte.
lang: it
title: Teorema del valor medio, matrice Jacobiana e regola della catena
---
...
In queste condizioni, esiste un punto $c \in (\mathbf{p}, \mathbf{q})$ tale che:
