---
description:
  Message passing, buffering, sockets, RPC, thread models, multicore
  parallelism, Amdahl's Law, and multithreading mappings.
lang: en
title:
  Synchronization, Threading, and Multicore Programming in Operating Systems
---
