...
## Materiali conduttori, isolanti e semi-conduttori

I materiali isolanti, conduttori e semi-conduttori si distinguono per la loro
struttura elettronica e il modo in cui reagiscono agli stimoli esterni.

Ecco alcuni parametri da considerare:

- resistività: alta per gli isolanti, bassa per i conduttori;
- bandgap: è l'energia termica necessaria per far muovere gli elettroni
  nell'atomo:
  - per i metalli è molto basso e conducono anche a basse temperature;
  - per i semi-conduttori è moderato, quindi ne basta una piccola quantità;
  - per gli isolanti è molto alto;
- coefficiente di temperatura: i metalli diventano più resistivi con il calore,
  i semi-conduttori più conduttivi;

I semi-conduttori si ottengono dalla quarta colonna della tavola periodica
...
Più atomi di silicio si legano con legami covalenti (elettrone condiviso tra 2
atomi). A temperatura $0\ K$ gli elettroni sono fissi nei legami e non possono
spostarsi, quindi il materiale è isolante.
...
creazione di una lacuna, che può essere riempita da altri elettroni liberi.
...
I semi-conduttori si comportano come una reazione reversibile tra legame intatto
...
silicio puro è sostanzialmente un isolante. Quindi da solo non sarebbe
utilizzabile per costruire circuiti.

:::note

In confronto, il rame ha resistività $\rho = 1.68\ 10^{-10}\ \Omega\ cm$ e
concentrazione di portatori $n = 8.46\ 10^{22}\ \frac{1}{cm^3}$.
