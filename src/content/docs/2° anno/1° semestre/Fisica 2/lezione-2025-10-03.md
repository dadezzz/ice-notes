...
- complesse se $\Delta < 0$:
  ...
  Nel caso sopra saranno $- \alpha \pm j \omega_0$.
  ...
  \begin{darray}{ll}
  I_{L_1}(t) &= k_1\ e^{x_1\ t} + k_2\ e^{x_2\ t} \\
             &= k_1\ e^{(- \alpha + j\ \omega_0)\ t} + k_2\ e^{(- \alpha + j\ \omega_0)\ t} \\
             &= e^{- \alpha\ t} (k_1\ e^{j\ \omega_0\ t} + k_2\ e^{- j\ \omega_0\ t}) \\
             &= e^{- \alpha\ t} (k_1\ (\cos(\omega_0\ t) + j\ \sin(\omega_0\ t)) + k_2\ (\cos(\omega_0\ t) - j\ \sin(\omega_0\ t))) \\
             &= e^{- \alpha\ t} (\cos(\omega_0\ t)\ (k_1 + k_2) + j\ \sin(\omega_0\ t)\ (k_1 - k_2)) \\
             &= e^{- \alpha\ t} (\cos(\omega_0\ t)\ A + \sin(\omega_0\ t)\ B) \\
             &= e^{- \alpha\ t} \sqrt{A^2 + B^2} \left(\frac{A \cos(\omega_0\ t)}{\sqrt{A^2 + B^2}} + \frac{B \sin(\omega_0 t)}{\sqrt{A^2 + B^2}}\right) \\
             &= e^{- \alpha\ t} \sqrt{A^2 + B^2} (\cos(\phi) \cos(\omega_0\ t) + \sin(\phi) \sin(\omega_0\ t)) \\
             &= e^{- \alpha\ t} K (\cos(\phi) \cos(\omega_0\ t) + \sin(\phi) \sin(\omega_0\ t)) \\
             &= e^{- \alpha\ t} K (\cos(\phi) \cos(\omega_0\ t) + \sin(\phi) \sin(\omega_0\ t)) \\
             &= e^{- \alpha\ t} K \cos(\omega_0\ t - \phi)
  \end{darray}
  $$
