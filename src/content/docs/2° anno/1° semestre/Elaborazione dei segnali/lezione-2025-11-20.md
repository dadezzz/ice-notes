...
ottiene un segnale di durata infinita e quindi infiniti campioni.

Questo tipo di filtro viene chiamato **Infinite Impulse Response** (IIR) ed è
irrealizzabile dato che la convoluzione richiederebbe una quantità infinita di
somme e prodotti. Per renderlo realizzabile bisogna tagliare il kernel ad una
...
risposta in frequenza), sia un effetto di aliasing.
...
Preso un LPF ideale, esso taglierà le frequenze maggiori di $f_0$. Applicandolo
