...
- Spettro di un sistema non distorcente:
  ...
  ![Spettri di ampiezza e fase di $H(f)$](../../../../../images/elaborazione-dei-segnali/spettro-sistema-non-distorcente.png)

- Spettro di un sistema distorcente:

  ![Spettri di ampiezza e fase di $H(f)$](../../../../../images/elaborazione-dei-segnali/spettro-sistema-distorcente.png)
...
$H_\text{tot}(f) = k e^{- j 2 \pi f t_0}$ e poi calcolare
...
$$
y(t) = a_1 \fCos{2 \pi f_0 t} + a_2 (\fCos{2 \pi f_0 t})^2 + \dots
...
$$
\left|\frac{\beta}{\alpha}\right| 100 \quad [\%]
$$
