...
casi dove non è possibile ricostruire il segnale. Considerando il funzionamento
di un filtro passa basso reale che taglia le frequenze in maniera graduale, è
consigliato anche aggiungere una costante, detta **banda di guardia**
($\varepsilon$) e quindi si ottiene:
...
Il picco di una singola $\fSinc{t}$ dà il valore del segnale nel punto di
campionamento. Negli altri punti invece essa viene annullata dalle $\fSinc{t}$
degli istanti precedente e successivo.
